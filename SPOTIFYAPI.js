...
! function e(t, n, r) {
    ...
    for (var o = "function" == typeof require && require, a = 0; a < r.length; a++) s(r[a]);
    return s
}({
    1: [function(e, t, n) {
        "use strict";
                ...
                ! function(n) {
                    ...
                    n = function(e, n) {
                        ...
                        if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) a = Reflect.decorate(e, t, n, r);
                            ...
                            for (var i = e.length - 1; i >= 0; i--)(s = e[i]) && (a = (o < 3 ? s(a) : o > 3 ? s(t, n, a) : s(t, n)) || a);
                        ...
                        var r = Array(e),
                            s = 0;
                        for (t = 0; t < n; t++)
                            for (var o = arguments[t], a = 0, i = o.length; a < i; a++, s++) r[s] = o[a];
                        return r
                    }, d = function(e, t, n) {
                    ...
                    }, e("__extends", n), e("__assign", r), e("__rest", s), e("__decorate", o), e("__param", a), e("__metadata", i), e("__awaiter", u), e("__generator", c), e("__exportStar", f), e("__createBinding", O), e("__values", l), e("__read", _), e("__spread", p), e("__spreadArrays", E), e("__spreadArray", d), e("__await", y), e("__asyncGenerator", h), e("__asyncDelegator", g), e("__asyncValues", v), e("__makeTemplateObject", R), e("__importStar", m), e("__importDefault", A), e("__classPrivateFieldGet", T), e("__classPrivateFieldSet", M)
                }))
            }).call(this)
    ...
    3: [function(e, t, n) {
        ...
        Object.defineProperty(n, "__esModule", {
            ...
            function(e) {
                e.ACCOUNT_ERROR = "account_error", e.AUTH_ERROR = "authentication_error", e.AUTOPLAY_FAILED = "autoplay_failed", e.PROGRESS = "progress", e.PLAYBACK_ERROR = "playback_error", e.PLAYER_INIT_ERROR = "initialization_error", e.PLAYER_READY = "ready", e.PLAYER_NOT_READY = "not_ready", e.PLAYER_STATE_CHANGED = "player_state_changed"
    ...
    7: [function(e, t, n) {
        ...
        function a() {
            if (!document.body) throw new s.PlayerError(r.Errors.NO_BODY, "Document doesn't have a body");
            if (window.Spotify = {
        ...
        n.setupPlayerEnv = function(e, t) {
            ...
            return function() {
                function t(t) {
                    ...
                    }, this._handleMessages = this._handleMessages.bind(this), this._eventListeners = ((n = {})[a.AnthemEvents.ACCOUNT_ERROR] = [], n[a.AnthemEvents.AUTH_ERROR] = [], n[a.AnthemEvents.AUTOPLAY_FAILED] = [], n[a.AnthemEvents.PLAYBACK_ERROR] = [], n[a.AnthemEvents.PLAYER_INIT_ERROR] = [], n[a.AnthemEvents.PLAYER_READY] = [], n[a.AnthemEvents.PLAYER_NOT_READY] = [], n[a.AnthemEvents.PLAYER_STATE_CHANGED] = [], n[a.AnthemEvents.PROGRESS] = [], n), this._connectionRequests = {}, this._getCurrentStateRequests = {}, this._getVolumeRequests = {}, this._messageHandlers = ((r = {})[o.Messages.GET_TOKEN] = this._onGetToken.bind(this), r[o.Messages.EVENT] = this._onEvent.bind(this), r[o.Messages.CONNECTED] = this._onConnected.bind(this), r[o.Messages.CURRENT_STATE] = this._onCurrentState.bind(this), r[o.Messages.VOLUME] = this._onVolume.bind(this), r), this.isLoaded = l.promise.then((function() {
                ...
                return t.prototype._getListeners = function(e) {
                    ...
                    return this.isLoaded.then((function() {
                        ...
                        return e._connectionRequests[n] = s.createPromiseResolver(), null === (t = e._connectionRequests[n]) || void 0 === t ? void 0 : t.promise
                    }))
                    ...
                    return this.isLoaded.then((function() {
                        ...
                        return e._getCurrentStateRequests[n] = s.createPromiseResolver(), null === (t = e._getCurrentStateRequests[n]) || void 0 === t ? void 0 : t.promise
                    }))
                }, t.prototype.getVolume = function() {
                    var e = this;
                    return this.isLoaded.then((function() {
                        var t, n = e._sendMessage(f.messages.getVolume());
                        return e._getVolumeRequests[n] = s.createPromiseResolver(), null === (t = e._getVolumeRequests[n]) || void 0 === t ? void 0 : t.promise
                    }))
